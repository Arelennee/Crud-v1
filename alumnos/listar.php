...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <table border="1" class="table table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row['ape_alum']; ?></td>
                <td><?php echo $row['fnac_alum']; ?></td>
                <td><?php echo $row['email_alum']; ?></td>
            </tr>
        <?php endwhile; ?>
        </tbody>
    ...
    <div class="row">
        <div class="col">
            <a href="./crear.php" class="text-decoration-none fs-3">Registrar Alumno</a>
        </div>
        <div class="col">
